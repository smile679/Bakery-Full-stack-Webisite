...
function FoodCard({ image, title, price, btnText, handleClick}) {
  return ( 
    <div className="w-full max-w-[400px] h-[250px] sm:h-[300px] relative rounded-2xl shadow-gray-800 shadow-md overflow-hidden">
      ...
      <img src={image} className='absolute top-1 right-1 sm:right-3 w-2xs sm:w-3xs'/>
      <div className='w-full text-white font-semibold absolute bottom-5 px-2 sm:px-5'>
        <h3 className='text-2xl mb-2 text-shadow-gray-800 text-shadow-md'>${price}</h3>
